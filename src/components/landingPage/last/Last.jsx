...
function Last() {
  return (
    <div className="bg-[#BDC7C9] font-['Open_Sans'] h-screen w-full flex flex-col justify-center place-content-center justify-items-center items-center pl-[4.8%] pr-[5.1%]">
