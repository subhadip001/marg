...
function Card(props) {
  return (
    <div className="relative font-['Open_Sans'] bg-white w-[26vw] h-[68vh]  max-w-sm overflow-hidden shadow-lg">
      ...
      <div className="px-[5%] py-[2%] mb-[8%] text-justify mt-[2%]">
        <div className="text-[#845460] font-bold text-[1.7vw] mb-[2%] text-center">
          {props.title}
        </div>
        <p className="text-gray-700 text-[100%]">{props.text}</p>
      </div>
      <div className="absolute bottom-[2%]  right-[1.8%]  bg-[#845460] w-[25%] pl-[1.2%] text-white">
        Read More
      </div>
    </div>
  );
