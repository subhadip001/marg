...
const Research = () => {
  const arr = [
    {
      link: "/themargnetwork/newinstitutionuser",
      name: "New Institution User",
    },
    {
      link: "/themargnetwork/associatedinstitutions",
      name: "Associated Research Institutions",
    },
    {
      link: "/themargnetwork/networkcontributions",
      name: "Network Contributions",
    },
  ];
  return (
